...
export default function ItalianProgramArticle({ onGoBack }) {
      ...
      <div className="mx-auto max-w-[1150px] px-4 sm:px-8 space-y-6">
        ...
        <div className="max-w-3xl space-y-2">
          <div className="flex items-center gap-3 text-[10px] font-semibold text-[#919191]">
            ...
            <span>•</span>
            <span>+620 Alumnos inscritos</span>
          </div>

          <h1 className="text-2xl font-extrabold tracking-tight text-[#111111] sm:text-3xl lg:text-[34px] leading-tight">
            Aprende italiano con fluidez, <span className="text-[#1D35E1]">pasión y precisión</span>
          </h1>

          <p className="text-xs sm:text-sm text-[#919191] font-normal leading-relaxed">
            Conecta con el diseño, la gastronomía, el arte y el mercado europeo a través de nuestro programa especializado en el idioma italiano.
          </p>
        </div>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-[#E4E4E7]/70 shadow-2xs h-[280px] sm:h-[380px] lg:h-[420px]">
          <img
            src={exampleImg}
            alt="Programa de Italiano en Euro Centro"
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="space-y-3 text-xs sm:text-sm text-[#666666] leading-relaxed">
              <h2 className="text-base sm:text-lg font-extrabold text-[#111111] tracking-tight">
                Fluidez expresiva para proyectos académicos y de negocios
              </h2>
              <p>
                El idioma italiano es la clave de acceso a sectores líderes como la moda, el automovilismo, la gastronomía, la arquitectura y los negocios internacionales en la Unión Europea.
              </p>
              <p>
                En <strong className="text-[#111111]">Euro Centro de Idiomas de México</strong>, diseñamos un plan de estudios dinámico que te permite aprovechar la similitud del español para avanzar con rapidez y corrección gramatical desde tus primeras lecciones.
              </p>
            </div>
            ...
            <div className="bg-[#F4F4F5]/60 rounded-xl p-4 border border-[#E4E4E7]/60 space-y-3">
              <h3 className="text-xs font-bold text-[#111111] uppercase tracking-wider flex items-center gap-2">
                ...
                ¿Qué ofrece nuestro curso de italiano?
              </h3>
              <ul className="space-y-2 text-[11px] sm:text-xs text-[#666666]">
                <li className="flex items-start gap-2">
                  ...
                  <span><strong>Preparación CILS y CELI:</strong> Certificaciones oficiales reconocidas internacionalmente.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-[#1D35E1] shrink-0 mt-0.5" />
                  <span><strong>Profesorado Calificado:</strong> Clases impartidas por especialistas en la enseñanza del italiano.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-[#1D35E1] shrink-0 mt-0.5" />
                  <span><strong>Desarrollo Integral:</strong> Lectura, redacción, expresión oral y compresión auditiva.</span>
                </li>
              </ul>
            </div>
            ...
            <blockquote className="border-l-2 border-[#1D35E1] pl-4 py-1 my-4 bg-slate-50/50 rounded-r-lg">
              <p className="text-xs sm:text-sm italic font-medium text-[#111111]">
                "Aprender italiano es incorporar una visión artística y profesional única, permitiéndote desenvolverte con naturalidad en cualquier escenario europeo."
              </p>
              <footer className="text-[10px] text-[#919191] mt-1 font-bold">
                — Área Académica de Italiano, Euro Centro
              </footer>
            </blockquote>
            ...
            <div className="rounded-2xl border border-[#E4E4E7]/80 bg-white p-5 shadow-2xs space-y-4">
              ...
              <div className="space-y-1 text-center">
                ...
                <h3 className="text-sm font-bold text-[#111111]">
                  Solicita información del Programa de Italiano
                </h3>
                <p className="text-[11px] text-[#919191]">
                  Recibe el temario, horarios y promociones vigentes en tu correo.
                </p>
              </div>
              ...
              <div className="flex items-center justify-center gap-2 py-1 border-y border-[#F4F4F5]">
                ...
                <span className="text-[10px] font-bold text-[#111111]">
                  +620 alumnos estudiando italiano
                </span>
              </div>
              ...
              <form onSubmit={(e) => e.preventDefault()} className="space-y-2.5">
                ...
                >
                  ...
                  <span>Obtener plan de italiano</span>
                </button>
              </form>
